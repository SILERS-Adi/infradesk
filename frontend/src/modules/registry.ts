...
export const invoicingModule: ModuleDefinition = {
  ...
  routeTitles: {
    ...
    '/invoicing/products/new': 'Faktury — Nowy produkt',
    '/invoicing/products/:id/edit': 'Faktury — Edycja produktu',
...
export const packagingModule: ModuleDefinition = {
  ...
  routeTitles: {
    '/packaging': 'Pakowanie',
    '/packaging/orders': 'Pakowanie — Zamówienia',
    '/packaging/packing': 'Pakowanie — Stacja pakowania',
    '/packaging/board': 'Pakowanie — Board',
    '/packaging/reports': 'Pakowanie — Statystyki',
    '/packaging/shipments': 'Pakowanie — Wysyłki',
