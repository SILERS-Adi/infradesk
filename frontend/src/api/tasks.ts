...
export const tasksApi = {
  ...
  update: async (id: string, payload: { title?: string; description?: string; assignedToUserId?: string; notes?: string; dueAt?: string; travelKm?: number | null; estimatedMinutes?: number | null }): Promise<Task> => {
