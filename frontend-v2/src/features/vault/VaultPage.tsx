  ...
  return (
    <Dialog.Root open={!!credential} onOpenChange={(o) => !o && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[92vw] max-w-[480px] bg-[var(--sf)] border border-[var(--bd)] rounded-[var(--r-m)] shadow-xl">
...
function AuditModal({ credential, onClose }: { credential: Credential | null; onClose: () => void }) {
  ...
  return (
    <Dialog.Root open={!!credential} onOpenChange={(o) => !o && onClose()}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-black/50 z-40" />
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[92vw] max-w-[560px] max-h-[80vh] bg-[var(--sf)] border border-[var(--bd)] rounded-[var(--r-m)] shadow-xl overflow-hidden flex flex-col">
          <div className="flex items-center justify-between p-[var(--sp-4)] border-b border-[var(--bd)]">
            <Dialog.Title className="text-[15px] font-semibold flex items-center gap-2">
              <History size={15} />
...
function CredentialFormModal({
  ...
  return (
    <Dialog.Root open={open} onOpenChange={(o) => !o && onClose()}>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-black/50 z-40" />
        <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[92vw] max-w-[560px] max-h-[85vh] bg-[var(--sf)] border border-[var(--bd)] rounded-[var(--r-m)] shadow-xl overflow-hidden flex flex-col">
